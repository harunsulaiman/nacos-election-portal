...
// ✅ UPDATED CORS CONFIGURATION for Vercel deployment (Handling Preflight)
// ____________________________________________________________________

// 1. Define the specific allowed origins
...
const corsOptions = {
    ...
    // Specify the methods, credentials are true for cookies/auth tokens
    methods: ['GET', 'POST', 'PUT', 'DELETE', 'PATCH', 'OPTIONS'], // Including common methods
    credentials: true,
};
...
// Explicitly handle OPTIONS preflight requests for all routes (Mandatory for complex requests)
